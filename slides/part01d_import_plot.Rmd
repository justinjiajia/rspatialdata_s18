...
```{r plot_sfcrimes, cache=TRUE}
gdb_dir <- "../exercises/data/sf_crime.gdb"
file.exists(gdb_dir)
ogrListLayers(gdb_dir)
sfcrime_sp <- readOGR(dsn=gdb_dir,layer="San_Francisco_Crimes")
class(sfcrime_sp)
...
```{r plot_ca, fig.align="center", out.height=400, cache=TRUE}
plot(ca_counties)
```
